...
void main(void)
{
	...
	vec3 glossy = texture(skybox, reflectionVector).rgb * km;

	// Tone mapping
	vec3 finalColor = tonemap(color + glossy, exposure);
